  ...
  const reviewsList = [
    {
      ...
      photo: JuliaReviewer,
      blockquote:
        '«Очень удобная платформа для инвестиций в криптовалюту, пользуюсь уже полгода»',
    },
    {
      name: 'Светлана Н',
      photo: SvetlanaReviewer,
      blockquote:
        '«Пользуюсь платформой уже больше года, нравится, что можно быстро и безопасно обменять криптовалюту на рубли»',
    },
    {
      name: 'Сергей А',
      photo: SergeiReviewer,
      blockquote:
        '«Класная платформа, менеджеры быстро отвечают на звонки и всегда помогают!»',
    },
  ];
